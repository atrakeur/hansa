...
public class CityPositions {
    ...
    public static IPosition GRONINGEN = new Position(0.056, 0.15339233);
    public static IPosition EMDEN = new Position(0.277, 0.147492625);
    public static IPosition BREMEN = new Position(0, 0);
    public static IPosition STADE = new Position(0.534, 0.088495575);
    public static IPosition HAMBURG = new Position(0.756666667, 0.057522124);
    public static IPosition LUBECK = new Position(0.903, 0.071779744);
    public static IPosition KAMPEN = new Position(0, 0);
    public static IPosition OSNABRUCK = new Position(0.26, 0.437561455);
    public static IPosition HANNOVER = new Position(0, 0);
    public static IPosition LUNEBURG = new Position(0.786, 0.291052114);
    ...
    public static IPosition BRUNSWIEK = new Position(0.727, 0.482792527);
    public static IPosition STENDAL = new Position(0.933333333, 0.53539823);
