...
public class HansaCoellenClickable {
    ...
    private final HansaCoellenClickableArea nineclickable;
    private final HansaCoellenClickableArea elevenclickable;

    public HansaCoellenClickable() {
        ...
        this.eightclickable = new HansaCoellenClickableArea(new VictoryCoellen(
                new City(CityPositions.COELLEN,null,kontors), CoellenPositions.EIGHTPOINTS,Privillegium.Orange,8));
        this.nineclickable = new HansaCoellenClickableArea(new VictoryCoellen(
